...
public enum CertificateTemplate {
    ...
    RED("RED CERTIFICATE", new DeviceRgb(255, 0, 0), 24, "/D://Şəxsi//My Photos//IMG_20230428_054656.jpg"),
    BLUE("BLUE CERTIFICATE", new DeviceRgb(0, 102, 204), 22, "BLUE_LOGO.png"),
    SIMPLE("SIMPLE CERTIFICATE", new DeviceRgb(255, 165, 0), 20, "SIMPLE_LOGO.png");
